...
import com.cinema.entity.MemberRole;
...
public class MemberServiceImpl implements MemberService {
  ...
  public String findId(FindIdDTO findIdDTO) {
    Optional<Member> member =
        memberRepository.findByPhoneAndEmail(findIdDTO.getPhone(), findIdDTO.getEmail());
  ...
  public boolean checkMemberToReset(CheckToResetPasswordDTO checkToResetPasswordDTO) {
    ...
    return memberRepository.existsByIdAndNameAndPhone(
        checkToResetPasswordDTO.getId(),
        checkToResetPasswordDTO.getName(),
        checkToResetPasswordDTO.getPhone());
  }
